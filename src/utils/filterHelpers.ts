export const applyFilter = (operator: any, filterType: string) => {
    ...
    switch (filterType) {
        ...
        case 'thisMonth':
            return (
                operatorDate.getMonth() === today.getMonth() &&
                operatorDate.getFullYear() === today.getFullYear()
            );
        case 'lastMonth':
            const lastMonth = new Date(today);
            lastMonth.setMonth(today.getMonth() - 1);
            return (
                operatorDate.getMonth() === lastMonth.getMonth() &&
                operatorDate.getFullYear() === lastMonth.getFullYear()
            );
        default:
            return true;
    }
